...
function ReportCard({
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "1rem", fontWeight: 600, color: "var(--text)", marginBottom: ".5rem", lineHeight: 1.4 }}>
        {report.topic}
      </div>
      <div style={{ fontSize: ".82rem", color: "var(--text2)", lineHeight: 1.5, marginBottom: "1rem", flex: 1 }}>
        {report.preview}
      </div>
    ...
    return (
      <div style={{ textAlign: "center", padding: "1rem" }}>
        <p style={{ color: "var(--text2)", marginBottom: "1rem" }}>
          This report requires <strong>$0.01 USDT</strong> via WDK.
        </p>
        <button

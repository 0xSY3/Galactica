...
const CATEGORIES = [
  ...
  { value: "sentiment", label: "Engagement" },
  { value: "prediction", label: "Prediction" },
  { value: "defi", label: "DeFi" },
  { value: "news", label: "Risk Monitor" },
...
const ARCH_SERVICES: ArchService[] = [
  { name: "Risk Monitor", port: 4004, price: "$0.001" },
  { name: "Engagement", port: 4001, price: "$0.001" },
  { name: "Yield Scanner", port: 4002, price: "$0.020" },
  { name: "DeFi", port: 4003, price: "$0.015" },
  { name: "Credit Analyzer", port: 4005, price: "$0.002" },
];
      ...
      {services.map((s) => {
        ...
        return (
          ...
          >
            ...
            <div className="latency-bar-outer" style={{ marginTop: 0 }}>
              <div
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            "linear-gradient(135deg, rgba(80,175,149,.15), rgba(247,147,26,.1))",
      ...
      >
        ...
        >
          Galactica Strategy Engine
        </div>
        <div style={{ fontSize: ".7rem", color: "var(--text3)" }}>
          Port 5050 &middot; Synthesize + Stake + Cache
        </div>
      </div>
      <div
        style={{

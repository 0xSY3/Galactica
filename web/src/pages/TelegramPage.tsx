    ...
    <>
      ...
      <div className="panel" style={{ marginBottom: "2rem" }}>
        ...
        >
          ...
          >
            <div style={{ fontSize: ".65rem", color: "var(--text3)", textTransform: "uppercase", letterSpacing: ".05em", marginBottom: ".2rem" }}>
              Chat ID
            </div>
            <div style={{ fontFamily: "var(--mono)", fontSize: ".82rem", fontWeight: 600, color: "var(--text)" }}>
              {isEnabled && status?.chatId ? status.chatId : "\u2014"}
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ fontFamily: "var(--mono)", fontSize: ".82rem", fontWeight: 600, color: "var(--accent2)" }}>
              {threshold}%
            </div>
          </div>
        </div>
      ...
      <div className="panel" style={{ marginBottom: "2rem" }}>
        ...
        >
          <p style={{ marginBottom: ".75rem" }}>
            To connect your Telegram bot to Galactica:
          </p>
      ...
      <div className="panel" style={{ marginBottom: "2rem" }}>
        ...
        >
          ...
          >
            Report: abc123def &middot; $0.01 via WDK USDT
          </div>
        </div>
      </div>
    </>

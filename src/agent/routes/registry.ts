...
export function registerRegistryRoutes(app: Application): void {
  ...
  app.get("/registry/protocol", (_req, res) => {
    res.json({
      protocol: "OpenClaw",
      version: "v1",
      description: "External agents register with Galactica to compete in alpha synthesis",
      healthEndpoint: {
        method: "GET",
        path: "/health",
      ...
      dataEndpoint: {
        ...
        note: "Paywalled via WDK USDT — include X-WDK-PAYMENT header for paid access",
